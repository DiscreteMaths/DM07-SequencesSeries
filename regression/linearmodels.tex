...
\item \textbf{Assumption 6}:Finally, you need to check that the residuals (errors) of your two variables are approximately normally distributed. Two common methods to check this assumption include using either a histogram (with a superimposed normal curve) or by using a Normal P-P Plot.
...
\begin{centering}
  % Requires \usepackage{graphicx}
  \includegraphics[width=12cm]{Regre4.jpg}\\
...
\begin{centering}
  % Requires \usepackage{graphicx}
  \includegraphics[width=12cm]{Regre5.jpg}\\
  \caption{ANOVA Table}
\end{centering}
\end{figure}
...
\begin{centering}
  % Requires \usepackage{graphicx}
  \includegraphics[width=12cm]{Regre6.jpg}\\
